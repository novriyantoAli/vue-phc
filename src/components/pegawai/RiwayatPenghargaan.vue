<template>
            <v-data-table
              ...
              :items="riwayatPenghargaan"
              sort-by="jenis_penghargaan"
              class="elevation-1">
              <template v-slot:top>
                <v-toolbar flat>
                        ...
                        <v-container>
                          <v-row>
                            <v-col cols="12" sm="6" md="4">
                              <v-text-field v-model="editedItem.jenis_penghargaan" label="Jenis Penghargaan">
                              </v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
<template>
  ...
  export default {
      ...
      data: () => ({
        ...
        { text: 'Jenis Penghargaan', value: 'jenis_penghargaan' },
        { text: 'Tanggal Diterima', value: 'tanggal_diterima' },
      ...
      methods: {
        ...
        saveItem () {
          if (this.editedIndex > -1) {
            Object.assign(
              this.riwayatPenghargaan[this.editedIndex], this.editedItem
            );
          } else {
            this.riwayatPenghargaan.push(this.editedItem);
          }
          this.close();
        },
        editItem (item) {
          this.editedIndex = this.riwayatPenghargaan.indexOf(item)
        ...
        deleteItemConfirm () {
          this.riwayatPenghargaan.splice(this.editedIndex, 1);
          this.closeDelete();
        },
