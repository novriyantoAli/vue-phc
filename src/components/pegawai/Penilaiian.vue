                      ...
                      <v-menu
                        ...
                        <v-date-picker
                          ...
                          @change="save">    
                            ...
                            <v-col cols="12" sm="6" md="4">
                              <v-text-field v-model="editedItem.nilai" label="Nilai">
                              </v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
      ...
      methods: {
        ...
        saveItem () {
          if (this.editedIndex > -1) {
            Object.assign(
              this.penilaiian[this.editedIndex], this.editedItem
            );
          } else {
            this.penilaiian.push(this.editedItem);
          }
          this.close();
        },
        editItem (item) {
          this.editedIndex = this.penilaiian.indexOf(item)
        ...
        deleteItemConfirm () {
          this.penilaiian.splice(this.editedIndex, 1);
          this.closeDelete();
        },
