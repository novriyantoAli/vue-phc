            ...
            <v-card-text>
              <v-container>
                      ...
                      <v-menu
                        ...
                        <template v-slot:activator="{ on, attrs }">
                          <v-text-field 
                            v-model="editedItem.terhitung_mulai"
                        ...
                        <v-date-picker
                          ...
                          @change="save">    
                            ...
                            <v-col cols="12" sm="6" md="4">
                              <v-text-field v-model="editedItem.nomor_sk" label="Nomor SK">
                              </v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                            ...
                            <v-col cols="12" sm="6" md="4">
                              <v-text-field v-model="editedItem.departemen" label="Departemen">
                              </v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
...
<script>
  export default {
      ...
      data: () => ({
        ...
        { text: 'Terhitung Mulai', value: 'terhitung_mulai' },
        { text: 'Nomor SK', value: 'nomor_sk' },
      ...
      methods: {
        ...
        saveItem () {
          if (this.editedIndex > -1) {
            Object.assign(
              this.riwayatPekerjaan[this.editedIndex], this.editedItem
            );
          } else {
            this.riwayatPekerjaan.push(this.editedItem);
          }
          this.close();
        },
        editItem (item) {
          this.editedIndex = this.riwayatPekerjaan.indexOf(item)
        ...
        deleteItemConfirm () {
          this.riwayatPekerjaan.splice(this.editedIndex, 1);
          this.closeDelete();
        },
